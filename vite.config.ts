...
const figmaSiteConfigurationPath = path.resolve(__dirname, './.figma/make/site.json')
const siteConfiguration: FigmaSiteConfiguration = existsSync(figmaSiteConfigurationPath)
  ? JSON.parse(readFileSync(figmaSiteConfigurationPath, 'utf8'))
  : {}
